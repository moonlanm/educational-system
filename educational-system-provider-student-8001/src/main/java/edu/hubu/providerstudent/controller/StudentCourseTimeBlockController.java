...
public class StudentCourseTimeBlockController {
    ...
    public CommonResult selectAll(@RequestParam(defaultValue = "studentCourseTimeBlockId") String orderBy) {
        List<StudentCourseTimeBlock> list = service.selectAllOrderBy(orderBy);
    ...
    public CommonResult selectAllPage(
        ...
        List<StudentCourseTimeBlock> list = service.selectAllPageOrderBy(currentPage, pageSize, orderBy);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
    ...
    public CommonResult selectLikePage(
        ...
        List<edu.hubu.commons.mybatis.model.StudentCourseTimeBlock> list = service.selectLikePageOrderBy(currentPage, pageSize,
            orderBy, studentCourseTimeBlock);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
