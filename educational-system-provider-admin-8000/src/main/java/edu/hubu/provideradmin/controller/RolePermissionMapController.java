...
public class RolePermissionMapController {
    ...
    public CommonResult selectAll(@RequestParam(defaultValue = "rolePermissionMapId") String orderBy) {
        List<RolePermissionMap> list = service.selectAllOrderBy(orderBy);
    ...
    public CommonResult selectAllPage(
        ...
        List<RolePermissionMap> list = service.selectAllPageOrderBy(currentPage, pageSize, orderBy);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
    ...
    public CommonResult selectLikePage(
        ...
        List<edu.hubu.commons.mybatis.model.RolePermissionMap> list = service.selectLikePageOrderBy(currentPage, pageSize,
            orderBy, rolePermissionMap);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
