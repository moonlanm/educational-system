...
public class PermissionController {
    ...
    public CommonResult selectAll(@RequestParam(defaultValue = "permissionId") String orderBy) {
        List<Permission> list = service.selectAllOrderBy(orderBy);
    ...
    public CommonResult selectAllPage(
        ...
        List<Permission> list = service.selectAllPageOrderBy(currentPage, pageSize, orderBy);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
    ...
    public CommonResult selectLikePage(
        ...
        List<edu.hubu.commons.mybatis.model.Permission> list = service.selectLikePageOrderBy(currentPage, pageSize,
            orderBy, permission);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
