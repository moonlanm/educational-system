...
public class AnnouncementContentController {
    ...
    public CommonResult selectAll(@RequestParam(defaultValue = "announcementContentId") String orderBy) {
        List<AnnouncementContent> list = service.selectAllOrderBy(orderBy);
    ...
    public CommonResult selectAllPage(
        ...
        List<AnnouncementContent> list = service.selectAllPageOrderBy(currentPage, pageSize, orderBy);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
    ...
    public CommonResult selectLikePage(
        ...
        List<edu.hubu.commons.mybatis.model.AnnouncementContent> list = service.selectLikePageOrderBy(currentPage, pageSize,
            orderBy, announcementContent);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
