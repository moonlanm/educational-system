...
public class TeacherCourseController {
    ...
    public CommonResult selectAll(@RequestParam(defaultValue = "teacherCourseId") String orderBy) {
        List<TeacherCourse> list = service.selectAllOrderBy(orderBy);
    ...
    public CommonResult selectAllPage(
        ...
        List<TeacherCourse> list = service.selectAllPageOrderBy(currentPage, pageSize, orderBy);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
    ...
    public CommonResult selectLikePage(
        ...
        List<edu.hubu.commons.mybatis.model.TeacherCourse> list = service.selectLikePageOrderBy(currentPage, pageSize,
            orderBy, teacherCourse);
        return new CommonResult().setCode(200).setCurrentPage(1)
            .setData(list)
            .setMessage("SUCCESS")
            .setTotal(list.size());
